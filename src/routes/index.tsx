  ...
  return (
    <div class="w-screen text-white h-screen flex justify-center items-center overflow-x-hidden">
      <div class="md:w-1/2 relative mb-12 sm:w-4/5 w-full lg:w-2/5 p-4">
        <div class="absolute inset-0 top-0 flex items-center justify-center h-full w-full pointer-events-none opacity-30 md:opacity-60">
        ...
        <div class="relative z-10">
          ...
          <p class="leading-6 mt-4 text-white">
            We make random but practical utilities for the web that actually solve real problems. Current projects -{" "}
            <MagicLink href="https://orchid.rex.wf" previewImage="/orchid.png">
              orchid (beta)
            </MagicLink>{" "}
            and{" "}
            <MagicLink href="/" previewImage="/aster.png">
              aster (closed)
            </MagicLink>
            .
          </p>
          ...
          <p class="text-neutral-100 text-sm">
            By{" "}
            <a href="https://namishh.me" class="link hover:underline">
              nam
            </a>{" "}
            and{" "}
            ...
            and{" "}
            <a href="https://github.com/floraorg" class="link hover:underline">
              github
            </a>
            .
          </p>
